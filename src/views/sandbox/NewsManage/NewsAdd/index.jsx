...
export default class NewsAdd extends Component {
  ...
  render() {
    const { currentSteps, categoryList } = this.state;
    return (
      <div>
        ...
        <div style={{ margin: '50px', padding: '10px 0 ' }}>
          ...
          <div className={currentSteps === 1 ? "" : "hide"}>
            <NewsEditor updataNewsContent={(content)=>this.updataNewsContent(content)}/>
          </div>
        ...
        {currentSteps === 2 && (
          <>
            <Button danger onClick={()=>this.saveNews(1)}>提交审核</Button>&nbsp;
